...
// You are developing a program for an amusement park to determine ticket prices based on age and day of the week. The park has the following pricing structure:

// Age-Based Pricing:

// If the visitor is under 5 years old, the ticket is free.
// If the visitor is between 5 and 12 yea  rs old, the ticket costs $10.
// If the visitor is between 13 and 59 years old, the ticket costs $20.
// If the visitor is 60 years old or above, the ticket costs $15.

// Day-Based Discount:
// On weekends (Saturday and Sunday), everyone gets a 20% discount on their ticket price.
...
if (age < 5) {
  ...
  ticketPrice = 10;
  discount = ticketPrice * discountPercentage;
